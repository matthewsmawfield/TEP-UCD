...
objects = {
    ...
    # Brown Dwarfs
    'Teide 1':     {'M': 55 * 317.8 * M_earth, 'R': 0.9 * 69911, 'type': 'bd', 'rho': 55*1.33/(0.9**3)},
    'Gliese 229B': {'M': 40 * 317.8 * M_earth, 'R': 0.8 * 69911, 'type': 'bd', 'rho': 40*1.33/(0.8**3)},
...
rbh = objects['RBH-1']
ax4.scatter(rbh['M_solar'], rbh['R_sol'], marker='*', s=200, c=COLORS['highlight'], edgecolors='k', zorder=10)
...
plt.savefig(os.path.join(output_dir, 'figure_6_ultimate_screening.png'), transparent=True)
