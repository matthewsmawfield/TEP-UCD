...
# --- 1. 26-object dataset (canonical, from step_5_ultimate_screening.py) ---
...
for name, obj in objects.items():
    if obj.get("type") == "bh":
        continue  # Exclude black holes from screening fit
    ...
    # Match step_5 sample selection: rho > rho_T only
    if obj["rho"] > rho_T:
