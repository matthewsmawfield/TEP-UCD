...
from core.constants import M_EARTH, M_SUN, R_EARTH, SCREENING_LENGTH_KM, RHO_C
...
def run_sensitivity_analysis():
    ...
    try:
        print_status("Numerical outputs saved to results/outputs/step_6_sensitivity.json", "SUCCESS")
    except Exception:
        pass
    return output_data
