...
def run_enhanced_analysis():
    ...
    ax3 = axes[1, 0]
    ax3.hist(residuals, bins=25, color='#56B4E9', 
    ...
    ax4 = axes[1, 1]
    ax4.scatter(M_arr, R_arr / R_pred, c='#CC79A7', s=20, alpha=0.5,
                edgecolors='none')
    ax4.axhline(1.0, color='black', linestyle='--', linewidth=1.5)
    ax4.axhline(np.median(R_arr / R_pred), color='#D55E00',
