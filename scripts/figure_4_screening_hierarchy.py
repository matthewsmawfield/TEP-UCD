...
ax1.text(rho_c*1.5, 0.6, r'$\rho_c \approx 20$ g/cm³', fontsize=9, rotation=90, va='bottom')

# Unity Line
ax1.axhline(y=1, color='gray', linestyle=':', alpha=0.5)
ax1.text(1e-1, 1.1, 'No Screening', fontsize=8, color='gray')
...
# Annotations
ax2.text(1e1, 1e5, "Screened Regime\n(Scalar Field > Physical)", fontsize=9, ha='center', color='#D55E00')
