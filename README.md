...
Dark matter observations across cosmological scales exhibit a regularity: the characteristic radius at which Newtonian dynamics fails scales as R ∝ M^(1/3), implying a universal critical proximity scale, observationally proxied by ρ_T. This scaling appears in galaxy rotation curves (SPARC database), ultra-diffuse galaxies (DF2/DF4), and the Milky Way's dark-matter onset. This pattern is interpreted within TEP as a candidate saturation scale in the conformal time-field sector of the Temporal Equivalence Principle (TEP), where field saturation occurs at a characteristic proximity scale, observationally proxied by the density ρ_T; a soliton interpretation is one candidate microscopic realization.
